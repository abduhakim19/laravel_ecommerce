                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card cart-summery">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mt-2">
                                    ...
                                    <div class="h6"><strong
                                            id="shippingAmount">${{ number_format($totalShippingCharge) }}</strong></div>
                                </div>
                        ...
                        <div class="card payment-form ">
                            <h3 class="card-title h5 mb-3">Payement Method</h3>
                            <div class="">
                                <input checked type="radio" name="payment_method" value="cod" id="payement_1">
                                <label for="payement_1" class="form-check-label">COD</label>
                            </div>

                            <div class="">
                                <input type="radio" name="payment_method" value="cod" id="payement_2">
                                <label for="payement_2" class="form-check-label">Stripe</label>
                            </div>

                            <div class="card-body p-0 d-none mt-3" id="card-payement-form">
                                <div class="mb-3">
...
@section('customJs')
    <script>
        $('#payement_1').click(function() {
            if ($(this).is(":checked") == true) {
                $("#card-payement-form").addClass("d-none");
            }
        });

        $('#payement_2').click(function() {
            if ($(this).is(":checked") == true) {
                $("#card-payement-form").removeClass("d-none");
            }
        });
